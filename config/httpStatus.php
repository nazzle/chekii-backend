...
/**
 * HTTP Status Codes as an associative array.
 *
 * This array maps common HTTP status names to their corresponding integer codes.
 * It can be used to easily reference status codes in your PHP application,
 * making your code more readable and maintainable than using magic numbers directly.
 */
return [
    // 1xx Informational
    'CONTINUE'                        => 100,
